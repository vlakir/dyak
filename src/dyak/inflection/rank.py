...
Пословный движок должностей (`PymorphyInflector`) ломает **составные**
звания: он тащит в целевой падеж и **несогласованный генитивный хвост**
(«майору медицинской **службе**» вместо «…службы», «капитану 3 **рангу**»
вместо «…ранга»), а дефисные служебные части склоняет как слова
(«**контрам**-адмиралу»). Звание устроено иначе, чем должность: голова
...
from dyak.inflection.pymorphy_phrase import inflect_word
