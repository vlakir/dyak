...
- **replaced** — значение строки уверенно найдено в документе и заменено
  на тег `{{ Заголовок }}` (в косвенном падеже — с фильтром).
- **ambiguous** — форма заменена, но падеж определён неоднозначно (омонимия
  форм): выбран первый по каноническому порядку, место подсвечено в шаблоне.
